...
].forEach(e => { if (POKEDEX_ZA_NATDEX[e]) POKEDEX_ZA[e] = POKEDEX_ZA_NATDEX[e]; });
if (POKEDEX_ZA['Meditite'] && POKEDEX_ZA['Meditite'].bs) POKEDEX_ZA['Meditite'].bs.at = 56;
if (POKEDEX_ZA['Medicham'] && POKEDEX_ZA['Medicham'].bs) POKEDEX_ZA['Medicham'].bs.at = 84;
if (POKEDEX_ZA['Mega Mawile'] && POKEDEX_ZA['Mega Mawile'].bs) POKEDEX_ZA['Mega Mawile'].bs.at = 147;
if (POKEDEX_ZA['Mega Medicham'] && POKEDEX_ZA['Mega Medicham'].bs) POKEDEX_ZA['Mega Medicham'].bs.at = 140;
if (POKEDEX_ZA['Mega Starmie'] && POKEDEX_ZA['Mega Starmie'].bs) POKEDEX_ZA['Mega Starmie'].bs.at = 140;
...
].forEach(e => { if (POKEDEX_ZA_NATDEX[e]) POKEDEX_CHAMPIONS[e] = POKEDEX_ZA_NATDEX[e]; });

//performs deep copy; necessary to preserve form data for nat dex
POKEDEX_CHAMPIONS = $.extend(true, {}, POKEDEX_CHAMPIONS);

if (POKEDEX_CHAMPIONS['Raichu']) POKEDEX_CHAMPIONS['Raichu'].formes = null;
if (POKEDEX_CHAMPIONS['Absol']) POKEDEX_CHAMPIONS['Absol'].formes = ["Absol", "Mega Absol"];
if (POKEDEX_CHAMPIONS['Garchomp']) POKEDEX_CHAMPIONS['Garchomp'].formes = ["Garchomp", "Mega Garchomp"];
if (POKEDEX_CHAMPIONS['Lucario']) POKEDEX_CHAMPIONS['Lucario'].formes = ["Lucario", "Mega Lucario"];